    ...
    <div className="min-h-[100dvh] flex flex-col items-center justify-center px-4 bg-white">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          Find trusted care for your loved ones in minutes.
        </p>
      </div>
      ...
      <form onSubmit={onSubmit} className="w-full max-w-sm space-y-4">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="h-12 border border-gray-300 rounded-lg pl-12"
            required
            autoComplete="email"
            aria-label="Email"
          />
      ...
      <div className="mt-6 text-center">
        ...
        <Link href="/family/signup" className="inline-block">
          <Button 
            variant="outline" 
      ...
      <div className="mt-4 text-center">
        <Link href="/family/reset-password" className="text-sm text-gray-600 underline hover:text-gray-800">
